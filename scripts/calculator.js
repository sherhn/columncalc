...
// Расчет требуемой площади сечения стержней по СП 16.13330.2017
...
export function getThicknessRanges(grade) {
...
export function calculateArea(ry, lambda, yc, forceSI, sectionType) {
  const guards = [
  ...
  return {
    ...
    force: forceSI,
    denominator, areaMinM2, areaMinCm2, yc,
  };
}
